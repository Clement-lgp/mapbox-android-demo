...
/**
 * Use {@link com.mapbox.turf.TurfMeasurement#distance(Point, Point)} to measure and display the distance
 * between the device location and the map camera's target
 */
public class StraightLineDistanceMapMovementActivity extends AppCompatActivity implements
  ...
  private static final String TAG = "StraightLineDistanceMapMovementActivity";
    ...
    mapView.getMapAsync(new OnMapReadyCallback() {
      ...
      public void onMapReady(@NonNull MapboxMap mapboxMap) {
        ...
        mapboxMap.setStyle(new Style.Builder()
            ...
            .withLayer(new LineLayer(LINE_LAYER_ID, SOURCE_ID).withProperties(
  ...
  private void showDistanceTextView() {
    distanceTextView = new TextView(this);
    distanceTextView.setLayoutParams(new FrameLayout.LayoutParams(90, 50, Gravity.CENTER));
    distanceTextView.setTextColor(Color.RED);
    mapView.addView(distanceTextView);
  }
      ...
      public void onStyleLoaded(@NonNull Style style) {
        ...
        if (geoJsonSource != null) {
          ...
          if (lastKnownLocation != null) {
            ...
            Point deviceLocationPoint = Point.fromLngLat(lastKnownLocation.getLongitude(), lastKnownLocation.getLatitude());
            ...
            double distanceBetweenDeviceAndTarget = TurfMeasurement.distance(deviceLocationPoint, targetPoint, UNIT_METERS);
            Log.d(TAG, "onStyleLoaded: distanceBetweenDeviceAndTarget = " + distanceBetweenDeviceAndTarget);
            distanceTextView.setText(String.valueOf(distanceBetweenDeviceAndTarget));
          }
        }
      }
    });
